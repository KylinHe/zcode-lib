...
type Resp_Arena_RoundEx_ struct {
	Uid              *int64                       `protobuf:"varint,1,opt,name=Uid" json:"Uid,omitempty"`
	EnemyUid         *int64                       `protobuf:"varint,2,opt,name=EnemyUid" json:"EnemyUid,omitempty"`
...
func (m *Resp_Arena_RoundEx_) GetUid() int64 {
	if m != nil && m.Uid != nil {
		return *m.Uid
	}
	return 0
...
func (m *Resp_Arena_RoundEx_) GetEnemyUid() int64 {
...
var fileDescriptor1 = []byte{
	...
	0xc9, 0xe6, 0xb0, 0x7d, 0xda, 0x2f, 0x7e, 0x6f, 0x23, 0xcd, 0xb7, 0x23, 0x31, 0x3a, 0x23, 0x89,
	0x6a, 0x0d, 0x5f, 0x00, 0xb0, 0x84, 0x30, 0xba, 0xce, 0x18, 0xfc, 0x37, 0x00, 0x00, 0xff, 0xff,
	0x06, 0x92, 0x5a, 0x26, 0x57, 0x11, 0x00, 0x00,
}
