...
const BoxIDIconBase int32 = 100000	// 宝箱id icon 拼接base值
// 小游戏相关
...
const (
	...
	BenefitStart int32 = BenefitStep //开始 对应第一个类型
	BenefitEnd int32 = BenefitBox  //结束 对应最后一个类型
)
